...
index = 1
File.open("../res5/cat2.res5").each_line do | line |
	l = line.split(" ");
	name = l[0].to_s
	sqrtts = l[1].to_f
	if sqrtts < 3
	...
	puts "<TR>"
	puts "<TD> <A href=img/" + name + ".png>" + index.to_s + "</A> <A href=img/" + name + "_fermi.png>LAT</A> </TS><TD>" + name + "</TD><TD>" + l[1] + "</TD><TD>" + l[2] + "</TD><TD>" + l[3] + "</TD><TD>" + l[4] + "</TD><TD>" + l[5] + "</TD><TD>" + l[6] + "</TD><TD>" + l[7] + "</TD><TD>" + l[8] + "</TD><TD>" + l[9] + "</TD><TD>" + l[10] + "</TD><TD>" + l[11] + "</TD><TD>" + l[12] + "</TD><TD>" + l[13] + "</TD><TD>" + l[14] + "</TD><TD>" + l[15] + "</TD><TD>" + l[16] + "</TD><TD>" + l[17] + "</TD>" + "</TD><TD>" + assfermi + "</TD>"
	puts "</TR>"
	index = index + 1
